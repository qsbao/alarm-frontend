...
INSERT INTO alarm (id, type, severity, message, alarm_value, unit, alarm_time, recovery_time, eqp_id, chamber_id, product_id, oper_name, owner, department, chart_owner_id, status, risk_level) VALUES
  ...
  ('alm-004', 'ChamberLeak', P2, 'Vacuum leak rate above tolerance',       0.33,   'sccm',  '2026-04-10 11:23:53+00:00', NULL,                       'CVD-04',   'A', 'F4-Metro','Endpoint detect', 'K. Müller', 'Facilities', NULL,          'Open',  P3),
  ...
  ('alm-011', 'TempSpike',   P1, 'Chamber temperature exceeded threshold', 269.71, '°C',    '2026-04-12 14:32:39+00:00', '2026-04-12 14:54:39+00:00','PVD-02',   'C', 'A7-Litho','Endpoint detect', 'H. Tanaka', 'Litho',      'user-rossi',  'Open',  P3),
  ('alm-014', 'ChamberLeak', P2, 'Vacuum leak rate above tolerance',       0.37,   'sccm',  '2026-04-25 10:51:31+00:00', '2026-04-25 11:44:31+00:00','CVD-04',   'D', 'A7-Litho','Recipe step 3',   'K. Müller', 'Facilities', 'user-smith',  'Open',  P0),
