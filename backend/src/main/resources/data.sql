...
INSERT INTO alarm (id, type, severity, message, alarm_value, unit, alarm_time, recovery_time, eqp_id, chamber_id, product_id, oper_name, owner, department, chart_owner_id, status, risk_level, details) VALUES
  ('alm-001', 'example-plugin:TempSpike',   'P1', 'Chamber temperature exceeded threshold', 202.69, '°C',    '2026-04-15 00:59:10+00:00', NULL,                       'CVD-04',   'A', 'D1-PVD',  'Lot start',      'H. Tanaka', 'Litho',      'user-rossi',  'Open',  NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":202.69,"thresholdTemp":180.0,"sensorId":"CVD-04-A-TC1","spikeStartTime":"2026-04-15T00:59:10Z","durationSeconds":120}'),
  ('alm-002', 'example-plugin:TempSpike',   'P1', 'Chamber pressure below setpoint',        10.78,  'mTorr', '2026-04-28 08:25:56+00:00', NULL,                       'CVD-09',   'C', 'F4-Metro','Endpoint detect', 'M. Chen',   'Etch',       'user-patel',  'Open',  NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":95.5,"thresholdTemp":85.0,"sensorId":"CVD-09-C-TC2","spikeStartTime":"2026-04-28T08:25:56Z","durationSeconds":60}'),
  ('alm-003', 'example-plugin:TempSpike',   'P2', 'Process gas flow out of range',          93.04,  'sccm',  '2026-04-21 18:34:24+00:00', NULL,                       'PVD-02',   'D', 'A7-Litho','Idle / standby',  'S. Patel',  'Etch',       'user-kim',    'Open',  NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":110.3,"thresholdTemp":100.0,"sensorId":"PVD-02-D-TC1","spikeStartTime":"2026-04-21T18:34:24Z","durationSeconds":45}'),
  ('alm-004', 'example-plugin:ChamberLeak', 'P2', 'Vacuum leak rate above tolerance',       0.33,   'sccm',  '2026-04-10 11:23:53+00:00', NULL,                       'CVD-04',   'A', 'F4-Metro','Endpoint detect', 'K. Müller', 'Facilities', NULL,          'Open',  'LOW_RISK',   '{"kind":"example-plugin:ChamberLeak","leakRate":0.33,"threshold":0.1,"chamberId":"CVD-04-A","testMethod":"helium"}'),
  ('alm-005', 'example-plugin:TempSpike',   'P2', 'DC bias voltage sag detected',           308.83, 'V',     '2026-04-04 11:34:28+00:00', NULL,                       'LITHO-07', 'D', 'C2-CVD',  'Idle / standby',  'L. Rossi',  'Litho',      'user-tanaka', 'Open',  NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":135.7,"thresholdTemp":120.0,"sensorId":"LITHO-07-D-TC1","spikeStartTime":"2026-04-04T11:34:28Z","durationSeconds":90}'),
  ('alm-006', 'example-plugin:TempSpike',   'P2', 'In-situ particle count spike',           15.97,  'cnt',   '2026-04-19 13:09:46+00:00', NULL,                       'METRO-01', 'C', 'F4-Metro','Recipe step 3',   'J. Smith',  'Facilities', NULL,          'Acked', NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":78.2,"thresholdTemp":70.0,"sensorId":"METRO-01-C-TC1","spikeStartTime":"2026-04-19T13:09:46Z","durationSeconds":30}'),
  ('alm-007', 'example-plugin:ChamberLeak', 'P3', 'Turbopump speed deviation',              957.54, 'Hz',    '2026-04-08 12:46:53+00:00', NULL,                       'CVD-04',   'D', 'A7-Litho','Process clean',   'A. Kim',    'Etch',       'user-chen',   'Acked', NULL,         '{"kind":"example-plugin:ChamberLeak","leakRate":0.25,"threshold":0.1,"chamberId":"CVD-04-D","testMethod":"helium"}'),
  ('alm-010', 'example-plugin:TempSpike',   'P0', 'Etch endpoint signal drift',             6.22,   '%',     '2026-04-04 08:46:33+00:00', NULL,                       'CVD-04',   'C', 'A7-Litho','Vent cycle',      'S. Patel',  'Etch',       'user-patel',  'Acked', NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":155.0,"thresholdTemp":140.0,"sensorId":"CVD-04-C-TC1","spikeStartTime":"2026-04-04T08:46:33Z","durationSeconds":75}'),
  ('alm-011', 'example-plugin:TempSpike',   'P1', 'Chamber temperature exceeded threshold', 269.71, '°C',    '2026-04-12 14:32:39+00:00', '2026-04-12 14:54:39+00:00','PVD-02',   'C', 'A7-Litho','Endpoint detect', 'H. Tanaka', 'Litho',      'user-rossi',  'Open',  'LOW_RISK',   '{"kind":"example-plugin:TempSpike","currentTemp":269.71,"thresholdTemp":250.0,"sensorId":"PVD-02-C-TC1","spikeStartTime":"2026-04-12T14:32:39Z","durationSeconds":1320}'),
  ('alm-014', 'example-plugin:ChamberLeak', 'P2', 'Vacuum leak rate above tolerance',       0.37,   'sccm',  '2026-04-25 10:51:31+00:00', '2026-04-25 11:44:31+00:00','CVD-04',   'D', 'A7-Litho','Recipe step 3',   'K. Müller', 'Facilities', 'user-smith',  'Open',  'HIGH_RISK',  '{"kind":"example-plugin:ChamberLeak","leakRate":0.37,"threshold":0.1,"chamberId":"CVD-04-D","testMethod":"helium"}'),
  ('alm-020', 'example-plugin:TempSpike',   'P0', 'Etch endpoint signal drift',             6.14,   '%',     '2026-04-01 13:20:07+00:00', '2026-04-01 14:01:07+00:00','LITHO-07', 'A', 'C2-CVD',  'Idle / standby',  'S. Patel',  'Etch',       'user-patel',  'Acked', NULL,         '{"kind":"example-plugin:TempSpike","currentTemp":148.0,"thresholdTemp":138.0,"sensorId":"LITHO-07-A-TC1","spikeStartTime":"2026-04-01T13:20:07Z","durationSeconds":2460}');
